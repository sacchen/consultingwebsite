  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b fixed w-full bg-white z-10">
        <nav className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="font-medium">Samuel Chen</div>
            <div className="space-x-6">
              <button onClick={() => scrollToSection('who')} className="text-gray-600 hover:text-gray-900">Who I Help</button>
              <button onClick={() => scrollToSection('services')} className="text-gray-600 hover:text-gray-900">Services</button>
      ...
      <main className="max-w-5xl mx-auto px-6 pt-24 pb-12">
        {/* Hero */}
        <div className="mb-16">
          <h1 className="text-5xl font-bold mb-4">Intelligent Support Without The Overhead</h1>
        ...
        <section id="who" className="mb-16 pt-16">
          <h2 className="text-3xl font-bold mb-8">Who I Help</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Technical Teams</h3>
              <p className="text-gray-600">Need someone to handle documentation and meeting notes while you focus on building? I'll attend your meetings, take detailed notes, and keep your docs organized.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Business & Founders</h3>
              <p className="text-gray-600">Looking for research support and professional representation? I'll help with market research, meeting attendance, and creating clear documentation to move your projects forward.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Policy & Research</h3>
              <p className="text-gray-600">Need help analyzing complex information? I'll review documents, create summary briefs, and handle stakeholder communications to support your work.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">What Makes Me Different</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Math & Analysis</h3>
                <p className="text-gray-600">Math major at Berkeley City College. I bring structured thinking to every task.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="bg-blue-100 p-3 h-12 w-12 rounded-lg flex items-center justify-center">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Tech & Policy Experience</h3>
                <p className="text-gray-600">From City Council work to software development, I bridge communication gaps.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="bg-blue-100 p-3 h-12 w-12 rounded-lg flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-gray-600">Experience representing organizations professionally in meetings and writing.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="mb-16 pt-16">
          <h2 className="text-3xl font-bold mb-8">How I Help</h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Meeting Support</h3>
              <ul className="space-y-2 text-gray-600">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">At Berkeley City Council, I sent letters of support to over 100 state legislators and represented the office at community events.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Technical Documentation</h3>
              <p className="text-gray-600">For Unhinge.dating, I handled documentation for new features and managed merging branches.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Project Management</h3>
              <p className="text-gray-600">I've managed a two-month AI safety research hub, organizing dinners and technical workshops.</p>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="mb-16 pt-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Hourly</h3>
              <p className="text-gray-600 mb-4">For specific tasks</p>
              <p className="text-2xl font-bold mb-4">$50/hour</p>
              <ul className="space-y-2 text-gray-600">
            ...
            <div className="border p-6 rounded-lg bg-blue-50">
              ...
              <p className="text-gray-600 mb-4">Best for regular needs</p>
              <p className="text-2xl font-bold mb-4">$900/month</p>
              <ul className="space-y-2 text-gray-600">
            ...
            <div className="border p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">For defined scope</p>
              <p className="text-2xl font-bold mb-4">From $500</p>
              <ul className="space-y-2 text-gray-600">
        ...
        <section id="contact" className="pt-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">Brief chat to understand your needs</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-blue-600 font-bold text-xl mb-2">2</div>
              <h3 className="font-semibold mb-2">Simple Plan</h3>
              <p className="text-gray-600">Clear proposal based on your needs</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-blue-600 font-bold text-xl mb-2">3</div>
              <h3 className="font-semibold mb-2">Start Small</h3>
              <p className="text-gray-600">Begin with a single task to ensure fit</p>
            </div>
          </div>
